...
const CaseRecordCMS = () => {
  ...
  const send = event => {
    ...
    axios.post("http://localhost:2000/api/admin/doc", formdata
      ...
      console.log(res);
      // alert("Updated files have been submitted!")
      ...
      <a href={affidavitOne}><img className="pdfone-aff"  src={pdf}/></a>
        ...
        <input  type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
          ...
          console.log(affidavitone)
              ...
              <p className="affidavith">Affidavit_M.hayat
              <select className="recordsdropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
        ...
        <input type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
         ...
         <p className="vakalatkundi">Vaqalat_M.Afnan

         <select className="vaqalatdropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
console.log(Witnessone)
              ...
              <p className="witnessone">Witness_M.Hayat
              <select className="witnessonedropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
<a href={affidavittwo}><img className="pdf-afftwo" src={pdf}/></a>
        ...
        <p className="affidavita">Affidavit_Mr.Ajmad
        <select className="affitwodropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
        ...
        <input type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
          ...
          console.log(Vaqalattwo)
                ...
                <p className="vatwo">Vaqalat_Akbarali
                <select className="vqltwodropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
console.log(Witnesstwo)
                ...
                <p className="wittwo">Witness_Akbarali
                <select className="wittwodropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
<a href={affidavitthree}><img className="pdf-affthree" src={pdf}/></a>
        ...
        <input  type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
          ...
          <p className="affidavitf">Affidavit_Mr.Tanveer
          <select className="affthreedropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
        ...
        <input type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
         ...
         <p className="vathree">Vaqalat_Mr.tanveer
         <select className="vqlthreedropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
console.log(Witnessthree)
                ...
                <p className="witthre">Witness_Farhan

                <select className="wit3dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
<a href={affidavitfour}><img className="pdf-afffour" src={pdf}/></a>
        ...
        <input  type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
          ...
          console.log(affidavitFour)
                  ...
                  <p className="affidavitd">Affidavit_Mr.Afaq
                  <select className="aff4dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
        ...
        <input type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
          ...
          <p className="vafour">Vaqalat_Muhmmad Nawaz
          <select className="vql4dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
console.log(Witnessfour)
      ...
      <p className="witnfour">Witness_Mr.Afaq
      <select className="wit4dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
<a href={affidavitfive}><img className="pdf-afffive" name="Affidavit_h" src={pdf}/>
        ...
        <p className="affidavitmn">Affidavit_Mr.Imran
        <select className="aff5dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
        ...
        <input type="file" id="file" name="image" multiple accept=".pdf,.jpg" onChange={event => {
          ...
          console.log(Vaqalatfive)
           ...
           <p className="vafive">Vaqalat_ImranAfzal
           <select className="vql5dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
...
console.log(Witnessfive)
    ...
    <p className="witnfive">Witness_Dr.Zohra
    <select className="wit5dropdown">
          <option>Witness</option>
          <option>Affidavit</option>
          <option>VaqalatNama</option>
